...
export default function Contact(scene,mount,mouse,camera,renderer) {
    const colors = [];
    let isMounted=false;
    let isDestroy=false;
    let startTime = null;
    ...
    let geometry = null
    let points=null
    loadTextData('Connect With us?', {size:10,button:false},(positions,explodePosition,geo,material)=>{
